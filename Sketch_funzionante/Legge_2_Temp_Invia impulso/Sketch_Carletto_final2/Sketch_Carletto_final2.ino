...
void loop() {
  ...
  if (Serial.available() > 0) 
  {
    ...
    switch (msg_in) 
    {
      case 49: digitalWrite(out1, LOW);  break;  // int corresponding to char 1
      case 50: digitalWrite(out1, HIGH); break;  // int corresponding to char 2
      case 51: digitalWrite(out2, LOW);  break;  // int corresponding to char 3
      case 52: digitalWrite(out2, HIGH); break;  // int corresponding to char 4
    }
  }
